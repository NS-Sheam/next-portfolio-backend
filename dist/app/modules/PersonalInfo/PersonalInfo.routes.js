...
router.post(
  "/",
  _sendFileToCloudinary.upload.single("file"),
  _textToJsonParser.default,
  _PersonalInfoController.PersonalInfoControllers.createPersonalInfo
);
...
router.patch(
  ...
  _sendFileToCloudinary.upload.single("file"),
  _textToJsonParser.default,
  _PersonalInfoController.PersonalInfoControllers.updatePersonalInfo
);
