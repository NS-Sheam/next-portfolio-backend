...
router.post("/", _sendImageToCloudinary.upload.single("file"), _textToJsonParser.default, _AchievementController.AchievementControllers.createAchievement);
...
router.patch("/:id", _sendImageToCloudinary.upload.single("file"), _textToJsonParser.default, _AchievementController.AchievementControllers.updateAchievement);
